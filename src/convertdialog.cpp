    ...
    wxDialog(parent, wxID_ANY, _("Convert HUD"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE)
{
    ...
    label_2 = new wxStaticText(this, wxID_ANY, wxT("label_2"));
...
void ConvertDialog::do_layout()
{
    ...
    wxFlexGridSizer* grid_sizer_1 = new wxFlexGridSizer(2, 2, 3, 3);
    ...
    sizer_6->Add(m_fontsize, 0, wxALL|wxADJUST_MINSIZE, 3);
    sizer_6->Add(m_size, 0, wxALL|wxADJUST_MINSIZE, 3);
    sizer_6->Add(m_stretchposition, 0, wxALL|wxADJUST_MINSIZE, 3);
    sizer_6->Add(label_2, 0, wxLEFT|wxEXPAND, 20);
