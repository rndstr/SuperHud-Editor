...
class PakManagerBase
{
   ...
   {
     pakcontentnode_t() : pakfilepath(0), buffer(0), bufsize(0) {}
  ...
  public:
    ...
    bool load( char **buf, const wxString& fpath, size_t *size = 0 ); 
    ...
    static bool load_from_zip( char **buf, const wxString& filepath, const wxString& entrypath, size_t *psize = 0 );
