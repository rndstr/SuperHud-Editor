...
#define _WX_PG_IMPLEMENT_VARIANT_DATA_CLASS(CLASSNAME, DATATYPE, AS_ARG, AS_ARG_CONST, DEFAULT_VALUE) \
    DECLARE_DYNAMIC_CLASS(CLASSNAME) \
protected: \
    DATATYPE m_value; \
public: \
    CLASSNAME() { } \
    CLASSNAME(AS_ARG_CONST value) { m_value = value; } \
    ...
    inline void SetValue(AS_ARG_CONST value) { m_value = value; } \
...
wxClassInfo* CLASSNAME##_ClassInfo = &CLASSNAME::ms_classInfo; \
IMPLEMENT_DYNAMIC_CLASS(CLASSNAME, BASECLASS) \
AS_ARG operator <<( AS_ARG value, const wxVariant &variant ) \
{ \
    wxASSERT( wxIsKindOf( variant.GetData(), CLASSNAME ) ); \
    CLASSNAME *data = (CLASSNAME*) variant.GetData(); \
    value = data->GetValue(); \
    return value; \
} \
...
AS_ARG DATATYPE##FromVariant( const wxVariant& v2 ) \
{ \
    CLASSNAME *data = (CLASSNAME*) v2.GetData(); \
    if ( !wxIsKindOf( data, CLASSNAME ) ) \
        return NULLVAL; \
...
DECL extern wxClassInfo* CLASSNAME##_ClassInfo;
...
public:
    ...
    */
    ...
    T& GetValueAs() const
    {
        wxPGVariantData* data = wxStaticCast(GetValue().GetData(), wxPGVariantData);
        wxASSERT_MSG( data->IsKindOf(CLASSINFO(wxPGVariantData)), wxT("Use GetValueAs only if value's variant data is wxPGVariantData-based") );
...
public:
    ...
    */
    ...
    void DoSetPropertyValues( const wxList& list, wxPGProperty* default_category );
...
public:
    ...
    */
    ...
    inline void* GetPropertyClientData( wxPGPropArg id ) const
    {
...
#define wxPG_PROP_ID_GETPROPVAL_CALL_PROLOG_RETVAL_WFALLBACK(TYPENAME, DEFVAL) \
    ...
    */
    ...
    /** Sets client data (void*) of a property.
        ...
        This untyped client data has to be deleted manually.
    */
    inline void SetPropertyClientData( wxPGPropArg id, void* clientData )
    {
        wxPG_PROP_ARG_CALL_PROLOG()
    ...
    */
    void SetPropertyValues( const wxList& list, wxPGPropArg defaultCategory = wxNullProperty )
    {
        wxPGProperty *p;
